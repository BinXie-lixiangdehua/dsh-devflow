 ...
 */
export class DefaultCommanderRuntimeAdapter implements CommanderRuntimeAdapter {
  execute(context: CommanderExecutionContext): Promise<CommanderRuntimeExecutionResult> {
 ...
 */
export class CommanderLocalRuntimeAdapter implements CommanderRuntimeAdapter {
  constructor(
    private readonly executor: CommanderActionExecutor,
