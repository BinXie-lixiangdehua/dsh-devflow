 ...
 */
export const DEVFLOW_COMMIT_TASK_KINDS: readonly DevFlowCommitKind[] = [
...
const ID_FIELDS = ['taskId', 'executionId', 'assignmentId', 'attemptId', 'reportId', 'phaseId', 'decisionId'] as const
 ...
 */
export function commitChangeOf(entry: DevFlowChangeSource): DevFlowCommitChange | null {
...
function kindOf(type: string, data: unknown): DevFlowCommitKind | null {
...
function entityIdOf(data: unknown): string | null {
