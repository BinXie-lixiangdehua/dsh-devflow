window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function dispatchSkillText(skills, hasDispatch) {
			if (!hasDispatch) return "—（当前没有派发）";
			if (skills === void 0 || skills.length === 0) return "未绑定技能（本次派发未注入）";
		...
		*/
		...
		function FlowCanvas(props) {
			...
			*/
			const [skin, setSkin] = (0, react.useState)(() => resolveSkin(readStoredSkin(safeStorage$2())));
					...
					node !== null && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						(0, react_jsx_runtime.jsxs)("dl", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: "本任务技能" }), (0, react_jsx_runtime.jsx)("dd", { children: node.dispatchSkillsLabel })] }),
		...
		*/
		...
		//#endregion
		//#region lib/client/activation-banner.js
		/**
		...
		*/
		...
		function readFlag$1(storage, key) {
		...
		function writeFlag$1(storage, key, folded) {
			if (storage === null) return;
			try {
				if (folded) storage.setItem(key, "1");
		...
		*/
		function activationFoldKey(failure) {
		...
		*/
		function activationBannerMode(failure, activation, storage) {
			...
			return {
				collapsible,
				folded: !readFlag$1(storage, activationFoldKey(failure))
			};
		}
		/**
		...
		*/
		function storeActivationFold(storage, failure, folded) {
			writeFlag$1(storage, activationFoldKey(failure), !folded);
		}
		/**
		...
		*/
		function blockedExpandKey(rows) {
			const digest = rows.map((row) => `${row.id}@${row.at}`).join("|");
			let hash = 5381;
			for (let index = 0; index < digest.length; index += 1) hash = (hash << 5) + hash + digest.charCodeAt(index) >>> 0;
		...
		*/
		function blockedBannerFolded(rows, storage) {
			if (rows.length === 0) return false;
			return !readFlag$1(storage, blockedExpandKey(rows));
		}
		/**
		...
		*/
		function storeBlockedFold(storage, rows, folded) {
			if (rows.length === 0) return;
			writeFlag$1(storage, blockedExpandKey(rows), !folded);
		}
		//#endregion
		...
		*/
		...
		function DevFlowCanvas(props) {
			...
			*/
			const [foldOverrides, setFoldOverrides] = (0, react.useState)({});
			...
			return (0, react_jsx_runtime.jsxs)("main", {
				...
				children: [
					failure !== null && verdict !== null && (0, react_jsx_runtime.jsx)("div", {
						className: `devflow-activation-failure${bannerFolded ? " is-folded" : ""}`,
						role: "status",
						...
						"data-activation-folded": String(bannerFolded),
						children: bannerFolded ? (0, react_jsx_runtime.jsxs)("span", {
							className: "devflow-activation-failure-one",
							children: [
								(0, react_jsx_runtime.jsx)("span", {
								...
								(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "devflow-activation-failure-toggle",
									"data-activation-toggle": "expand",
									onClick: () => {
										setFolded(false);
									},
									children: "展开"
							...
							(0, react_jsx_runtime.jsxs)("span", {
								className: "devflow-activation-failure-head-row",
								children: [(0, react_jsx_runtime.jsx)("span", {
									className: "devflow-activation-failure-head",
									children: verdict.headline
								}), bannerMode.collapsible && (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "devflow-activation-failure-toggle",
									"data-activation-toggle": "fold",
									onClick: () => {
										setFolded(true);
									},
									children: "收起横幅"
					...
					blockedRows.length > 0 && (0, react_jsx_runtime.jsx)("div", {
						className: `devflow-blocked-banner${blockedFolded ? " is-folded" : ""}`,
						role: "status",
						"data-blocked-count": String(blockedRows.length),
						"data-blocked-folded": String(blockedFolded),
						children: blockedFolded ? (0, react_jsx_runtime.jsxs)("span", {
							className: "devflow-blocked-headrow",
							children: [
								(0, react_jsx_runtime.jsxs)("span", {
								...
								(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "devflow-blocked-toggle",
									"data-blocked-toggle": "expand",
									onClick: () => {
										setBlockedFolded(false);
									},
									children: "展开"
								}),
								(0, react_jsx_runtime.jsx)("span", {
									className: "devflow-blocked-latest",
									children: blockedRows[0]?.headline
								})
							]
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								type: "button",
								className: "devflow-blocked-toggle",
								"data-blocked-toggle": "fold",
								onClick: () => {
									setBlockedFolded(true);
								},
								children: "收起"
							})]
...
.devflow-activation-failure{display:flex;flex-direction:column;gap:3px;margin:0 0 12px;padding:9px 12px;border-left:3px solid var(--red);background:rgba(238,129,126,.1)}.devflow-activation-failure-head{color:var(--ink);font-size:13px;font-weight:600;line-height:1.45}.devflow-activation-failure-code{color:var(--muted);font:10px var(--ds-font-family-code,ui-monospace,monospace);letter-spacing:.02em;overflow-wrap:anywhere}.devflow-activation-failure-reason{color:var(--muted);font-size:11px;line-height:1.45}.devflow-activation-failure-meta{color:var(--muted);font:10px var(--ds-font-family-code,ui-monospace,monospace)}.devflow-activation-failure-head-row{display:flex;align-items:flex-start;gap:10px}.devflow-activation-failure-head-row .devflow-activation-failure-head{flex:1 1 auto;min-width:0}.devflow-activation-failure-toggle{flex:0 0 auto;border:1px solid var(--line);border-radius:3px;background:rgba(177,201,219,.08);color:var(--ink);font-size:11px;line-height:1.4;padding:1px 8px;cursor:pointer}.devflow-activation-failure-toggle:hover{border-color:var(--blue);color:var(--blue)}.devflow-activation-failure.is-folded{gap:0;padding:6px 10px}.devflow-activation-failure-one{display:flex;align-items:center;gap:8px;min-width:0}.devflow-activation-failure-one .devflow-activation-failure-head{flex:1 1 auto;min-width:0;font-size:12px;font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.devflow-activation-failure-one .devflow-activation-failure-code{flex:0 0 auto}.devflow-activation-failure-one .devflow-activation-failure-toggle{flex:0 0 auto;align-self:auto}
