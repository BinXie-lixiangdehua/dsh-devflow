...
export const SUPPORTED_PROTOCOL_VERSIONS = ['0.1', '0.2', '0.3', '0.4'];
 ...
 */
export function createTaskPackage(task, project, options = {}) {
 ...
 */
export function parseResultPackage(input) {
    if (!isRecord(input))
        throw new Error('Invalid agent result package: expected an object');
