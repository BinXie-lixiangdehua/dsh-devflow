 ...
 * remove.
 */
export const ACTIVATION_CODE_REASONS_ZH = {
...
export const ACTIVATION_PHASE_REASONS_ZH = {
    initial: '首次激活',
    recompose: '切换 preset',
    deactivate: '撤销激活',
    restore: '回滚恢复',
...
export const DEVFLOW_ACTIVATION_CODE_LIST = Object.keys(ACTIVATION_CODE_REASONS_ZH);
/**
 ...
 */
export function activationReasonZh(code) {
