...
import { type DevFlowActivationProvider } from './preset-activation.ts';
/**
 ...
 */
export declare function resolveActivationMode(mode: DevFlowSessionActivationMode, presetService: () => unknown): DevFlowResolvedActivationMode;
/**
 ...
 */
export declare function createDevFlowSessionActivation(deps: DevFlowSessionActivationDeps, mode?: DevFlowSessionActivationMode): DevFlowSessionActivationHook;
