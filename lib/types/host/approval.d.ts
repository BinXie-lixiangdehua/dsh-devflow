 ...
 */
export declare class ManualApprovalProvider implements ApprovalProvider {
    private readonly decide;
    constructor(decide: (proposal: CommanderProposal) => ApprovalResult);
 ...
 */
export declare class RuleApprovalProvider implements ApprovalProvider {
    approve(proposal: CommanderProposal): ApprovalResult;
}
