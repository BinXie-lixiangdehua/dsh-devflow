 ...
 */
export declare class CommanderGovernanceChecker {
    /**
     ...
     */
    check(policy: Omit<CommanderPolicy, 'createdAt' | 'updatedAt'> | undefined, input: CommanderDecisionInput, retryCount: number): CommanderGovernanceResult;
}
