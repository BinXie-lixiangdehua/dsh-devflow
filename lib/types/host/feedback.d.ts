 ...
 */
export declare class MemoryFeedbackBridge {
    private readonly writer;
    constructor(writer: CommanderMemoryWriter);
    /**
 ...
 */
export declare class CommanderFeedbackProcessor {
    private readonly readState;
    private readonly bridge;
    constructor(readState: () => DevFlowProjectionState, bridge: MemoryFeedbackBridge);
    /**
