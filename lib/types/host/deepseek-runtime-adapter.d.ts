 ...
 */
import { CommanderExternalRuntimeAdapter, type CommanderRuntimeExecutionRequest, type CommanderRuntimeTransport } from './commander-external-runtime-adapter.ts';
 ...
 * connection.
 */
export declare class DeepSeekRuntimeAdapter extends CommanderExternalRuntimeAdapter {
