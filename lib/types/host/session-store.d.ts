...
export declare const DEVFLOW_STATE_DIR_NAME = ".devflow";
/**
 ...
 */
export declare const DEVFLOW_SESSION_SCOPE_UNAVAILABLE = "DEVFLOW_SESSION_SCOPE_UNAVAILABLE";
/** The refusal raised when a session cannot be scoped to its own workspace. */
export declare class DevFlowSessionScopeError extends Error {
 ...
 */
export type DevFlowSandboxPolicyResolver = (agent: Agent | undefined) => {
 ...
 */
export declare function deriveProjectNameFromWorkspace(workspace: string): string;
/**
 ...
 */
export declare function deriveNewProjectIdentity(workspace: string): {
 ...
 */
export declare function deriveSessionStoreRoot(workspace: string | undefined, defaultRoot: string, sessionId: string): string;
/**
 ...
 */
export declare class DevFlowSessionStores {
    private readonly fs;
     ...
     */
    constructor(fs: ConstructorParameters<typeof DevFlowStore>[0], defaultRoot: string, onChange?: ((sessionKey: string, relativePath: string, sequence?: number, record?: {
