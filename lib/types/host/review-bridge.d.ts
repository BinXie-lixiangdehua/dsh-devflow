 ...
 */
export declare function buildCommanderDecisionInput(review: CommanderReview, input: ReviewDecisionInput): Omit<CommanderDecision, 'decisionId' | 'createdAt' | 'updatedAt'>;
