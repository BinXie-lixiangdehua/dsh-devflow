 ...
 */
export declare function readGlassOverride(search: string): DevFlowGlassForce;
...
export declare class MotionBudget {
    private slow;
    private fast;
    private long;
    /**
...
export declare function meanFrameMs(gaps: readonly number[]): number | null;
